...
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20250516.0.0[${PYTHON_USEDEP}]
...
RDEPEND="${RDEPEND}
	...
	dhcp? ( ~dev-python/aiodhcpwatcher-1.1.1[${PYTHON_USEDEP}] )
	...
	esphome? ( ~dev-python/aioesphomeapi-30.1.0[${PYTHON_USEDEP}] )
	...
	home_connect? ( ~dev-python/aiohomeconnect-0.17.0[${PYTHON_USEDEP}] )
	...
	lifx? ( ~dev-python/aiolifx-1.1.4[${PYTHON_USEDEP}] )
	...
	bluetooth? ( ~dev-python/bluetooth-auto-recovery-1.5.1[${PYTHON_USEDEP}] )
	...
	decora_wifi? ( ~dev-python/deebot-client-13.2.0[${PYTHON_USEDEP}] )
	decora? ( ~dev-python/deebot-client-13.2.0[${PYTHON_USEDEP}] )
	ecovacs? ( ~dev-python/deebot-client-13.2.0[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/gcal-sync-7.0.1[${PYTHON_USEDEP}] )
	...
	google_travel_time? ( ~dev-python/google-maps-routing-0.6.14[${PYTHON_USEDEP}] )
	...
	holiday? ( ~dev-python/holidays-0.72.0[${PYTHON_USEDEP}] )
	workday? ( ~dev-python/holidays-0.72.0[${PYTHON_USEDEP}] )
	frontend? ( ~dev-python/home-assistant-frontend-20250516.0.0[${PYTHON_USEDEP}] )
	conversation? ( ~dev-python/home-assistant-intents-2025.5.7[${PYTHON_USEDEP}] )
	...
	google? ( ~dev-python/ical-9.2.4[${PYTHON_USEDEP}] )
	local_calendar? ( ~dev-python/ical-9.2.4[${PYTHON_USEDEP}] )
	local_todo? ( ~dev-python/ical-9.2.4[${PYTHON_USEDEP}] )
	remote_calendar? ( ~dev-python/ical-9.2.4[${PYTHON_USEDEP}] )
	...
	influxdb? ( ~dev-python/influxdb-client-1.24.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/knx-frontend-2025.3.8[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/lcn-frontend-0.2.4[${PYTHON_USEDEP}] )
	...
	motion_blinds? ( ~dev-python/motionblinds-0.6.26[${PYTHON_USEDEP}] )
	...
	niko_home_control? ( ~dev-python/nhc-0.4.10[${PYTHON_USEDEP}] )
	...
	ecovacs? ( ~dev-python/py-sucks-0.9.10[${PYTHON_USEDEP}] )
	synology_dsm? ( ~dev-python/py-synologydsm-api-2.7.1[${PYTHON_USEDEP}] )
	...
	ezviz? ( ~dev-python/pyezviz-0.2.1[${PYTHON_USEDEP}] )
	...
	lcn? ( ~dev-python/pypck-0.8.5[${PYTHON_USEDEP}] )
	...
	suez_water? ( ~dev-python/pysuezv2-2.0.4[${PYTHON_USEDEP}] )
	...
	emulated_kasa? ( ~dev-python/sense-energy-0.13.7[${PYTHON_USEDEP}] )
	...
	switchbot_cloud? ( ~dev-python/switchbot-api-2.3.1[${PYTHON_USEDEP}] )
	...
	teslemetry? ( ~dev-python/teslemetry-stream-0.7.7[${PYTHON_USEDEP}] )
	...
	unifiprotect? ( ~dev-python/uiprotect-7.6.0[${PYTHON_USEDEP}] )
	...
	knx? ( ~dev-python/xknx-3.6.0[${PYTHON_USEDEP}] )
	...
	media_extractor? ( ~dev-python/yt-dlp-2025.3.31[${PYTHON_USEDEP}] )
