...
SRC_URI="https://files.pythonhosted.org/packages/79/9f/e1e337683863d03bcfed00fa91470d490e5f5024772cad4ac22a73cbe19a/deebot_client-13.5.0.tar.gz -> ${P}.gh.tar.gz"
SRC_URI+="
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/deebot_client-13.5.0"
